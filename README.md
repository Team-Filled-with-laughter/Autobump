...
- 레이더 센서(순간 속도) -> 레이더 센서에 빠르게 다가올수록 주파수 측정값이 높게 측정됨 -> **속도 공식(TRM-121A 만든 회사에서 제공)을 이용**해 속도값 변환
- 무게 센서(구간 속도)   -> A 지점 밟은 순간부터 B 지점 밟은 순간까지 시간 측정 -> **속력 = (거리/시간)을 이용**해 속도값 변환
